...
def run_basic_simulation():
    ...
    # Verify convergence
    assert (
        replica1.counter.value() == replica2.counter.value() == replica3.counter.value()
    )
